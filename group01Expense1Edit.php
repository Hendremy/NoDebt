...
<head>
    <meta charset="utf-8">
    <title>No Debt - Editer dépense Plein d'essence</title>
...
<body>
    ...
    ?>
    <main>
        <h1>Plein d'essence - Editer dépense</h1>
        <form class="field-list" action="group01.php">
            ...
            <select name="participant" id="participant" required>
                ...
                <option value="participant2" selected>Helmut Frites</option>
                <option value="participant3">Hans Zwei</option>
                <option value="participant4">Jean Néplin</option>
            </select>
            <label for="expenseDate">Date</label>
            <input type="date" name="date" id="expenseDate" value="2021-05-01" readonly required/>
            <label for="amount">Montant en euros (€)</label>
            <input type="number" name="amount" id="amount" value="60" required/>
            <label for="name">Libellé</label>
            <input type="text" name="name" id="name" value="Plein d'essence" required/>
