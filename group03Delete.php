...
<head>
    <meta charset="utf-8">
    <title>No Debt - Supprimer le groupe Soirée jeux de société</title>
...
<main>
    <header>
        <h1>Supprimer le groupe Soirée jeux de société</h1>
    </header>
    ...
    <section class="choices deleteChoices">
        ...
        <form action="group03Settled.php" class="decline-delete">
