...
<head>
    <meta charset="utf-8">
    <title>No Debt - Editer dépense Ingrédients burger</title>
...
?>
<main>
    <h1>Ingrédients burger - Editer dépense</h1>
    <form class="field-list" action="group03.php">
        ...
        <input type="date" name="date" id="expenseDate" value="2021-09-08" readonly required/>
        <label for="amount">Montant en euros (€)</label>
        <input type="number" name="amount" id="amount" value="75" required/>
        <label for="name">Libellé</label>
        <input type="text" name="name" id="name" value="Ingrédients burger" required/>
