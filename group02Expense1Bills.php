...
<head>
    <meta charset="utf-8">
    <title>No Debt - Dépense Equipement karaté - Factures</title>
...
?>
<main>
    <h1>Dépense Equipement karaté - Factures</h1>
    <h2>Ajouter une facture</h2>
    <form class="field-list" action="group02Expense1Bills.php">
    ...
    <ul class="bills-list">
        <li>
            <img alt="scan facture 1" src="img/group02Expense1Bill1.png"/>
            <form>
