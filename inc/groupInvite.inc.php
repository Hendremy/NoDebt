...
<article class="invitation">
    ...
    <ul class="invitationChoice choices">
        <li>
            <form action="inviteAccept.php" class="accept-invite">
                <input type="hidden" name="gid" value="<?php echo $group->gid?>"/>
                <button type="submit" class="accept"><img src="images/accept.png" alt="Accepter" class="iconx32"/></button>
            </form>
        </li>
        <li>
            <form action="groupPeek.php" class="decline-invite">
                <input type="hidden" name="gid" value="<?php echo $group->gid?>"/>
