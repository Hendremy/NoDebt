...
<head>
    <meta charset="utf-8">
    <title>No Debt - Editer dépense Paté de crabe</title>
...
?>
<main>
    <h1>Paté de crabe - Editer dépense</h1>
    <form class="field-list" action="group02.php">
        ...
        <select name="participant" id="participant" required>
            ...
            <option value="participant3" selected>Patrick Etoile</option>
        ...
        <input type="text" name="name" id="name" value="Paté de crabe" required/>
