...
<head>
    <meta charset="utf-8">
    <title>No Debt - Ajouter une dépense au groupe Soirée jeux de société</title>
...
?>
    <main>
        <h1>Ajouter une dépense au groupe Soirée jeux de société</h1>
        <form action="group03.php">
            ...
            <select name="participant" id="participant" required>
                ...
                <option value="participant3">Nono Debt</option>
            </select>
